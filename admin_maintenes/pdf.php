...
<p align="center"> <strong>Hasil Maintenes Hardware</strong></p><br/>
...
$sql=mysql_query("SELECT * FROM maintenes_tehnisi where  tanggal ='$tgl' and id_ruang = '$id_ruang' ") or die(mysql_error());
