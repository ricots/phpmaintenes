...
<body>
<form action="home.php?m=content&p=cari_tindakan" name="postform" method="post">
...
<table width="880" border="1">
 ...
 color:#F00;
  ...
  <td class="txt" rowspan="0" colspan="9" align="center">Silahkan meakukan pencarian untuk melihat data maintenes</td>
</tr>
